    ...
    <div className="field">
      ...
      <div style={{ position: "relative" }}>
        ...
        <input
          ...
          style={{ paddingLeft: 40, paddingRight: pw ? 40 : 13 }}
          required
        />
        {pw && (
          <button
            type="button"
            onClick={() => setShow((s) => !s)}
            style={{ position: "absolute", right: 11, top: "50%", transform: "translateY(-50%)", color: "var(--ink-4)" }}
          >
  ...
  return (
    <div style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr" }} className="auth-grid">
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(80% 60% at 80% 10%, rgba(14,159,110,.35), transparent 55%), radial-gradient(60% 50% at 10% 90%, rgba(199,154,58,.22), transparent 55%)",
          }}
        />
        <Link href="/" style={{ position: "relative", alignSelf: "flex-start" }}>
          <Logo light size={21} />
        </Link>
        <div style={{ position: "relative", margin: "auto 0", maxWidth: 420 }}>
          <div style={{ marginBottom: 30 }}>
            <img src="/provenly-mark.svg" alt="Provenly" width={156} height={156} style={{ display: "block", width: 156, height: 156 }} />
          </div>
          ...
          <p style={{ marginTop: 16, fontSize: 16.5, color: "rgba(255,255,255,.7)", lineHeight: 1.55 }}>
            Join thousands of educators, creators and event teams issuing tamper-proof certificates with instant public verification.
          </p>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 28px", background: "var(--canvas)" }}>
        <div style={{ position: "relative", width: "100%", maxWidth: 380, animation: "fade-up .5s both" }}>
          <div className="auth-brand-mini" style={{ display: "none", marginBottom: 24 }}>
            <Logo size={21} />
          </div>

          <button className="btn btn-ghost btn-block" style={{ height: 48 }} onClick={google} type="button">
            <svg width="18" height="18" viewBox="0 0 24 24">
              <path fill="#4285F4" d="M22.5 12.2c0-.8-.1-1.5-.2-2.2H12v4.3h5.9a5 5 0 01-2.2 3.3v2.7h3.6c2.1-2 3.2-4.9 3.2-8.1z" />
              <path fill="#34A853" d="M12 23c2.9 0 5.4-1 7.2-2.7l-3.6-2.7c-1 .7-2.3 1-3.6 1-2.8 0-5.1-1.9-6-4.4H2.3v2.8A11 11 0 0012 23z" />
              <path fill="#FBBC05" d="M6 14.2a6.6 6.6 0 010-4.2V7.2H2.3a11 11 0 000 9.8L6 14.2z" />
              <path fill="#EA4335" d="M12 5.4c1.6 0 3 .5 4.1 1.6l3.1-3.1A11 11 0 002.3 7.2L6 10c.9-2.6 3.2-4.6 6-4.6z" />
            </svg>
          ...
          <div style={{ display: "flex", width: "100%", padding: 4, background: "var(--canvas-2)", borderRadius: 11 }}>
            {(
              [
                ["signup", "Sign up"],
                ["login", "Log in"],
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: mode === k ? "var(--sh-1)" : "none",
                  transition: "all .18s",
                }}
              >
                {l}
          ...
          <h1 style={{ fontSize: 23, letterSpacing: "-0.02em", marginTop: 22 }}>{signup ? "Create your account" : "Welcome back"}</h1>
          <p className="muted" style={{ marginTop: 6, fontSize: 14.5 }}>
            {signup ? "Start with 5 free certificate credits." : "Log in to manage your certificates."}
          </p>
          ...
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 15 }}>
            ...
            {error && (
              <div style={{ fontSize: 13.5, color: "var(--danger)", background: "var(--danger-tint)", padding: "9px 12px", borderRadius: 8 }}>
                {error}
              </div>
            )}
          ...
          <p className="muted" style={{ fontSize: 13, textAlign: "center", marginTop: 18, lineHeight: 1.5 }}>
            {signup ? (
              ...
              <>
                New here?{" "}
                <button onClick={() => setMode("signup")} className="tlink">
                  Create an account
                </button>
              </>
            )}
